# This function was deprecated in shinyWidgets package, with a warning that directed to download the source code from https://raw.githubusercontent.com/dreamRs/shinyWidgets/26838f9e9ccdc90a47178b45318d110f5812d6e1/R/setSliderColor.R if necessary for use.
# Thus, this is code from that URL on 2024-01-13
#
#
